...
conn.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        title: "Focalorz Multi device\nThe knowledge WhatsApp bot",
        body: wm,
        thumbnailUrl: thumb,
        sourceUrl: "https://focalorz.on.top/",
        mediaType: 1,
...
global.dfail = (type, m, conn) => {
    ...
    let Syaiithumb = 'https://telegra.ph/file/bca8e6858de47726ba23b.jpg'
    let Syaiithumb2 = 'https://telegra.ph/file/bca8e6858de47726ba23b.jpg'
...
let msg = {
 ...
 if (msg) return conn.sendMessage(m.chat,{text: msg, contextInfo: {
    ...
    forwardedNewsletterMessageInfo: {
      ...
      newsletterName: 'Focalorz Bot WhatsApp',
      serverMessageId: -1
    },
    businessMessageForwardInfo: { businessOwnerJid: '62881026950162@s.whatsapp.net' },
    forwardingScore: 256,
    externalAdReply: {
      title: 'Focalorz (ver ' + version + ' )',
      body: 'Focalorz Bot WhatsApp',
