...
let handler = async (m, { conn, text }) => {
 ...
 if (!text) throw `*• Example:* .focalorz *[on/off]*`;
...
handler.command = ['focalorz'];
handler.tags = ["ai"]
handler.help = ['focalorz'].map(a => a + " *[on/off]*");
